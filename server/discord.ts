...
// Import the shared isDirectQuestion function from utils
    ...
    this.client.on(Events.MessageCreate, async (message: Message) => {
      try {
        ...
        // Priority 4: Even when not in streaming mode, respond to direct questions and greetings
          ...
          const isDirectQuestionResult = isDirectQuestion(message.content);
          ...
          if (isDirectQuestionResult || isDirectGreeting) {
            shouldRespond = true;
